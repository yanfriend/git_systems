...
type Message struct {
	...
	User          string                 `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"` // Username
	Text          string                 `protobuf:"bytes,2,opt,name=text,proto3" json:"text,omitempty"` // Message content
...
var file_chat_proto_rawDesc = string([]byte{
	...
	0x04, 0x74, 0x65, 0x78, 0x74, 0x32, 0x38, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x30, 0x0a,
...
var file_chat_proto_depIdxs = []int32{
	0, // 0: chat.Chat.ChatStream:input_type -> chat.Message
	0, // 1: chat.Chat.ChatStream:output_type -> chat.Message
